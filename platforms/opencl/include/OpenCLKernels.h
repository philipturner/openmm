...
private:
    ...
    NS::SharedPtr<MTL::ComputePipelineState> computeParamsKernel, computeExclusionParamsKernel;
    NS::SharedPtr<MTL::ComputePipelineState> ewaldSumsKernel;
    NS::SharedPtr<MTL::ComputePipelineState> ewaldForcesKernel;
    NS::SharedPtr<MTL::ComputePipelineState> pmeAtomRangeKernel;
    NS::SharedPtr<MTL::ComputePipelineState> pmeDispersionAtomRangeKernel;
    NS::SharedPtr<MTL::ComputePipelineState> pmeZIndexKernel;
    NS::SharedPtr<MTL::ComputePipelineState> pmeDispersionZIndexKernel;
    NS::SharedPtr<MTL::ComputePipelineState> pmeGridIndexKernel;
    NS::SharedPtr<MTL::ComputePipelineState> pmeDispersionGridIndexKernel;
    NS::SharedPtr<MTL::ComputePipelineState> pmeSpreadChargeKernel;
    NS::SharedPtr<MTL::ComputePipelineState> pmeDispersionSpreadChargeKernel;
    NS::SharedPtr<MTL::ComputePipelineState> pmeFinishSpreadChargeKernel;
    NS::SharedPtr<MTL::ComputePipelineState> pmeDispersionFinishSpreadChargeKernel;
    NS::SharedPtr<MTL::ComputePipelineState> pmeConvolutionKernel;
    NS::SharedPtr<MTL::ComputePipelineState> pmeDispersionConvolutionKernel;
    NS::SharedPtr<MTL::ComputePipelineState> pmeEvalEnergyKernel;
    NS::SharedPtr<MTL::ComputePipelineState> pmeDispersionEvalEnergyKernel;
    NS::SharedPtr<MTL::ComputePipelineState> pmeInterpolateForceKernel;
    NS::SharedPtr<MTL::ComputePipelineState> pmeDispersionInterpolateForceKernel;
