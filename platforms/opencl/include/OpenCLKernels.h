...
private:
    ...
    OpenCLKernel computeParamsKernel, computeExclusionParamsKernel;
    OpenCLKernel ewaldSumsKernel;
    OpenCLKernel ewaldForcesKernel;
    OpenCLKernel pmeAtomRangeKernel;
    OpenCLKernel pmeDispersionAtomRangeKernel;
    OpenCLKernel pmeZIndexKernel;
    OpenCLKernel pmeDispersionZIndexKernel;
    OpenCLKernel pmeGridIndexKernel;
    OpenCLKernel pmeDispersionGridIndexKernel;
    OpenCLKernel pmeSpreadChargeKernel;
    OpenCLKernel pmeDispersionSpreadChargeKernel;
    OpenCLKernel pmeFinishSpreadChargeKernel;
    OpenCLKernel pmeDispersionFinishSpreadChargeKernel;
    OpenCLKernel pmeConvolutionKernel;
    OpenCLKernel pmeDispersionConvolutionKernel;
    OpenCLKernel pmeEvalEnergyKernel;
    OpenCLKernel pmeDispersionEvalEnergyKernel;
    OpenCLKernel pmeInterpolateForceKernel;
    OpenCLKernel pmeDispersionInterpolateForceKernel;
